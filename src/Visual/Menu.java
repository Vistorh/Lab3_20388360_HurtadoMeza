    ...
    public void desplegarMenu() {
        ...
        while(!cerrarMenu){
            ...
            if(!(ctrl.existeOnline())){//reviso online para que se registre o se loge
                ...
                System.out.println("7. Visualizar usuario");
                ...
                try {
                    ...
                    switch (opcion){
                        ...
                        case 6: //search
                            ...
                            input.nextLine();
                            String textoBuscar = input.nextLine();
                            ctrl.search(textoBuscar);
                            break;
                        ...
                        case 8://cerrar sesion ->logout
                            System.out.println("Sesion cerrada.\n");
                            //Logout
                            ctrl.logout();
                            break;
                        case 9://salir del programa ->cerrar menu
